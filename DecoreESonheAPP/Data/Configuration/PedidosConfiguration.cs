...
namespace DecoreESonheAPP.Data.Configurations
{
    public class PedidosConfiguration : IEntityTypeConfiguration<Pedido>
    {
        public void Configure(EntityTypeBuilder<Pedido> builder)
        {
            ...
            builder.Property(c => c.DataEntrega).HasColumnType("Date").IsRequired(false);
            builder.Property(c => c.DataPagamento).HasColumnType("Date").IsRequired(false);
            builder.Property(c => c.Status).HasConversion<string>().IsRequired();
            builder.Property(c => c.TipoEntrega).HasConversion<string>().IsRequired(false);
            builder.Property(c => c.TipoPagamento).HasConversion<string>().IsRequired(false);
            builder.Property(c => c.CanalVenda).HasConversion<string>().IsRequired(false);
